...
class _LoginScreenState extends State<LoginScreen> {
  ...
  // void signInOnTab(context) async {
  //   BlocProvider.of<loginCubit>(context).gitUsersBloc(phoneController.text);
  //   BlocConsumer<AuthenticationCubit, AuthenticationState>(
  //     listener: (context, state) {},
  //     builder: (context, state) {
  //       if (state is LoginLodingState) {
  //         return LoginCompunants.showDialogLoading(context);
  //       } else if (state is LoginSucsessState) {
  //         Navigator.pushNamed(
  //             context, AppRouterStrings.navigationBarRouteString);
  //       }
  //       return LoginCompunants.showDialogLoading(context);
  //     },
  //   );
